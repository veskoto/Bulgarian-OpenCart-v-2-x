...
$_['help_tax_default']                 = 'Use the store address to calculate taxes if no one is се вписа. You can choose to use the store address for the customers shipping or payment address.';
...
$_['help_customer_price']              = 'Only show prices when a customer is се вписа.';
...
$_['error_store']                      = 'Внимание: This Store cannot be deleted as it is currently assigned to %s поръчки!';