...
// Text
$_['text_success']					= 'Успешно: Променихте PayPal Direct (UK) account details!';
$_['text_edit']                     = 'Редакция PayPal Payflow Pro';
...
// Error
$_['error_permission']				= 'Внимание: Нямате права за редакция на payment PayPal Website Payment Pro (UK)!';
