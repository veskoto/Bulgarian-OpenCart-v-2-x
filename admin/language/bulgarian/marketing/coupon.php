...
// Text
$_['text_success']        = 'Успешно: Променихте coupons!';
$_['text_list']           = 'Coupon Списък';
...
$_['help_logged']         = 'Customer must be се вписа to use the coupon.';
...
// Error
$_['error_permission']    = 'Внимание: Нямате права за редакция на coupons!';
$_['error_exists']        = 'Внимание: Кода вече е използван!';
$_['error_name']          = 'Coupon Name трябва да е между 3 и 128 символа!';
